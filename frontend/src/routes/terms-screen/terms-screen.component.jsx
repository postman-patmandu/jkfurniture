...
const TermsScreen = () => {
  const title="Rustic Furniture, Furniture Shop Terms & Conditions Page";
  ...
  return (
    <div>
        <Helmet>
            ...
            <link rel="canonical" href="https://www.furnitureshop.nz/terms" />
            {/* <Meta tite={metaDetails.title} description={metaDetails.description} keywords={metaDetails.keywords} /> */}
        </Helmet>
        {/* <Meta title={title} description={description} keywords={keywords} /> */}
        <h1 className='mt-5'>Terms &amp; Conditions for Furniture Shop</h1>
        ...
        <ul>
            <li>
                <p><strong>Return Policy</strong>: If you are not satisfied with your purchase, you may return eligible products within [Insert Time Frame, e.g., 30 days] of delivery for a refund, subject to our return policy. Items must be returned in their original condition and packaging.</p>
            </li>
            <li>
        ...
        <p>These Terms are governed by and construed in accordance with the laws of [Your Jurisdiction], without regard to its conflict of law principles. Any disputes arising under these Terms will be subject to the exclusive jurisdiction of the courts in [Your Jurisdiction].</p>
